...
class FinishDesktop extends StatefulWidget {
  @override
  _FinishDesktopState createState() => _FinishDesktopState();
}

class _FinishDesktopState extends State<FinishDesktop> {
  Quizes _quizes;
  bool isLoad = true;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text("QRIOSITY", textAlign: TextAlign.center,
                style: GoogleFonts.poppins(color: Theme
                    .of(context)
                    .accentColor, fontSize: 30,fontWeight: FontWeight.w700),),
            ),
            Card(
              shape:
