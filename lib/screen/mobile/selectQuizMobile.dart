      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Please wait, getting questions", style: GoogleFonts.poppins(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 18),),
          ],
        ),
      );
    }
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Hero(tag:'selectLogo',child: Image.asset("assets/images/logomed.png", height: _mediaQuery.height*0.05,)),
              ),
              Container(
                  margin: EdgeInsets.only(top: _mediaQuery.height * 0.05),
                  child: RichText(
              ...
              Container(
                width: _mediaQuery.width * 0.8,
                margin: EdgeInsets.only(top: _mediaQuery.height * 0.02, bottom:  _mediaQuery.height*0.02),
                child: Text(
                  "Select topic",
                  style: GoogleFonts.poppins(
                      color: Colors.white,
